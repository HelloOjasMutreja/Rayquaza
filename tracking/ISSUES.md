...
- [OPEN] 2026-06-16 [A] LEAK-1 | verify.c:40–57 | cmov() | Category: compiler-level branch
...
- [OPEN] 2026-06-16 [A] LEAK-2 | poly.c:191–210 | poly_tomsg() | Category: branch on secret-derived rounding
...
- [OPEN] 2026-06-16 [A] LEAK-3 | ntt.c:139–145 | basemul() | Category: timing on secret key coefficients
...
- [OPEN] 2026-06-16 [A] LEAK-4 | ntt.c:106–126 | invntt() via barrett_reduce | Category: branch on secret-derived NTT values
...
- [OPEN] 2026-06-16 [A] LEAK-5 | kem.c:116 → verify.c:16–25 | verify() FO comparison | Category: timing oracle via non-CT compare
