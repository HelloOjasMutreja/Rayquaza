...
## In Progress
- [A] LEAK-3 (basemul ARM timing) — ARM instance provisioned (AWS t4g.micro Graviton2, ap-southeast-2). Target kyber512_leak3/harness_oracle.c created. Awaiting oracle run on ARM hardware.
